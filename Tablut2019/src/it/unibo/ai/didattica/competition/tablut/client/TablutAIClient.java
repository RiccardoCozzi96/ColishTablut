...
public class TablutAIClient extends TablutClient {
	...
	public TablutAIClient(String player, String name, int gameChosen, int timeout, String ipAddress) throws UnknownHostException, IOException {
	...
	public static void main(String[] args) throws UnknownHostException, IOException, ClassNotFoundException {
		...
		TablutAIClient client = new TablutAIClient(role, name, gametype, timeout, ipAddress);
		client.run();
	}
